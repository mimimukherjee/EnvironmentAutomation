...
output "soa_instance_id" {
  value = "${lookup(data.oci_core_instances.soa_instances.instances[0], "id")}"
}

output "soa_vnic_attachments" {
  value = "${data.oci_core_vnic_attachments.soa_vnic_attachments.vnic_attachments}"
}
